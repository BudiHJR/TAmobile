...
public class TebakSuara5Activity extends AppCompatActivity {
    ...
    private void playSound(int arg){
        ...
        if (arg == 1){
            player = MediaPlayer.create(this, R.raw.suara_srigala_fix);
        }
