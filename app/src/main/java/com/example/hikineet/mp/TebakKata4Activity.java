...
public class TebakKata4Activity extends AppCompatActivity {
    ...
    private void playSound(int arg){
        ...
        if (arg == 1){
            player = MediaPlayer.create(this, R.raw.burung);
        }
